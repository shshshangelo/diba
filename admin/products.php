...
<form action="" method="POST" enctype="multipart/form-data" id="addProductForm">
    ...
    <input type="number" min="0" max="9999999999" required placeholder="Menu Price" name="price"
...
<div class="flex-btn">
    ...
    <!-- Bootstrap Modal Delete Button -->
    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal<?= $fetch_products['id']; ?>">
        Delete
    </button>
