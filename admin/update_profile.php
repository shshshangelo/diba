...
<section class="form-container">
   ...
   <form action="" method="POST">
      ...
      <input type="password" name="old_pass" maxlength="50" placeholder="Enter your Old Password" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="password" name="new_pass" maxlength="50" placeholder="Enter your New Password" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="password" name="confirm_pass" maxlength="50" placeholder="Confirm your New Password" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
